"""iyum_co_20526 URL Configuration
...
admin.site.site_header = "iYUM CO"
admin.site.site_title = "iYUM CO Admin Portal"
admin.site.index_title = "iYUM CO Admin"

# swagger
api_info = openapi.Info(
    title="iYUM CO API",
    default_version="v1",
    description="API documentation for iYUM CO App",
)
